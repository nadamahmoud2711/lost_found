...
<header class="header">
    <div class="container">
        ...
        <!--</div>-->
        <!--<div class="single-header-info">-->
        <!--&lt;!&ndash; Modal: donate now Starts &ndash;&gt;-->
        ...
        <!--<form action="http://hasan.themexlab.com/new/lillah-fund-html/contact.html" method="post">-->
        <!---->
        <!--&lt;!&ndash;Form Portlet&ndash;&gt;-->
        ...
        <!--</div>-->
        <!--</div>-->
        <!--&lt;!&ndash; Modal: donate now Ends &ndash;&gt;-->
        <!--</div>-->
        <!--</div>-->
    </div>
</header> <!-- /.header -->
...
<nav class="mainmenu-area stricky">
    <div class="container">
        <div class="navigation pull-right">
            <div class="nav-header">
                <ul>
                    ...
                    <li><a href="index-4.html">الرئيسية</a></li>
                </ul>
            </div>
        ...
        <div class="pull-left">
            ...
            <!--</form>-->
            <button type="button" class="btn btn-lg mt_15 btn-outline-info">إنشاء حساب</button>
            <button type="button" class="btn btn-lg mt_15 btn-info">تسجيل الدخول</button>
